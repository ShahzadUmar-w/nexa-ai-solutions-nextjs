...
const OFFICE_SERVICE_PAGES: Record<OfficeServiceKey, ServicePageData> = {
  ...
  outlook: {
    ...
    path: ROUTES.outlook,
    metaTitle: "Outlook Add-in Development Services",
    metaDescription:
      "Custom Outlook add-in development for inbox automation, CRM sync, and AI-powered email workflows. Built with Office.js task panes, compose extensions, and Microsoft 365 deployment.",
    keywords: [
      "Outlook add-in development",
      "Outlook add-in services",
      "custom Outlook add-in",
      "Office.js Outlook add-in",
      "email automation Outlook",
      "Outlook task pane add-in",
      "CRM integration Outlook",
