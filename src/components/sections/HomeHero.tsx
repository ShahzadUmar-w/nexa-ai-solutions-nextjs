          ...
          <FadeIn delay={0.3} className="relative mt-12 lg:mt-0">
            ...
            <div className="relative z-10 flex justify-center lg:justify-end">
              <div className="relative w-full max-w-[550px] group">
                ...
                <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-4 space-y-3 opacity-0 lg:opacity-100">
                   <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-indigo-500/50" />
                   <p className="text-[10px] font-mono text-indigo-400/60 rotate-90 origin-left">EST. 2024</p>
                </div>
